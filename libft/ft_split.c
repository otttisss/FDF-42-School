...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/09 16:59:11 by cmilagro          #+#    #+#             */
/*   Updated: 2021/11/09 17:00:38 by cmilagro         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_free_mem(char **mem)
{
	int	i;
...
static char	**ft_pre_split(char const *s, char c)
{
	size_t	i;
	size_t	j;
	char	**str;
